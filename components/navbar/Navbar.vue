        ...
        <div class="flex items-center">
          ...
          <div class="lg:block hidden px-4">
            <div class="relative">
              ...
              <input class="border-2 border-gradient-tr-pink-purple bg-transparent pl-10 pr-2 py-2 text-sm focus:bg-gray-100 text-gray-800" placeholder="Search by keywords" />
            </div>
          </div>
          ...
          <nuxt-link to="/explore" class="lg:hidden flex font-medium text-sm hover:text-white group">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="fill-current text-gray-100 h-6 w-6">
              <path class="secondary" d="M16.32 14.9l1.1 1.1c.4-.02.83.13 1.14.44l3 3a1.5 1.5 0 01-2.12 2.12l-3-3a1.5 1.5 0 01-.44-1.14l-1.1-1.1a8 8 0 111.41-1.41zM10 16a6 6 0 100-12 6 6 0 000 12z" />
            </svg>
          </nuxt-link>
        ...
        <nav :class="isOpen ? 'block' : 'hidden'" class="sm:block">
          <div class="sm:p-0 sm:px-4 py-5 sm:flex items-center">
            <nuxt-link to="/explore" class="flex sm:mx-4 mt-2 sm:mt-0 font-medium text-sm hover:text-white group">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="fill-current text-gray-100 h-6 w-6">
                <path class="secondary" d="M14 10h2a1 1 0 01.81 1.58l-5 7A1 1 0 0110 18v-4H8a1 1 0 01-.81-1.58l5-7A1 1 0 0114 6v4z" />
              </svg>
            ...
            <nuxt-link to="/tracklist/12" class="flex sm:mx-4 mt-2 sm:mt-0 font-medium text-sm hover:text-white group">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="fill-current text-gray-100 h-6 w-6">
                <path class="primary" d="M22 17a1 1 0 01-2 0v-5a8 8 0 10-16 0v5a1 1 0 01-2 0v-5a10 10 0 1120 0v5z" />
                <path class="secondary" d="M7 12a2 2 0 012 2v6a2 2 0 11-4 0v-6c0-1.1.9-2 2-2zm10 0a2 2 0 012 2v6a2 2 0 11-4 0v-6c0-1.1.9-2 2-2z" />
              </svg>
            ...
            <nuxt-link to="/tracklist/add" class="flex sm:mx-4 mt-2 sm:mt-0 font-medium text-sm hover:text-white group bg-transparent hover:bg-gradient-bl-pink-purple font-semibold py-2 px-4 border border-gradient-bl-pink-purple rounded">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="fill-current text-gray-100 h-6 w-6">
                <path class="secondary" d="M13 11h4a1 1 0 010 2h-4v4a1 1 0 01-2 0v-4H7a1 1 0 010-2h4V7a1 1 0 012 0v4z" />
              </svg>
