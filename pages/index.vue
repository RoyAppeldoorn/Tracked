    ...
    <div class="relative py-24 sm:pb-64 sm:pt-48 overflow-x-hidden ">
      <div class="relative container mx-auto px-4 sm:px-0">
        <div role="presentation" class="absolute inset-0">
          <div class="top-0 right-0 bottom-0 block absolute origin-center transform rotate-180">
            <svg class="block h-48 w-48" viewBox="0 0 184 184" xmlns="http://www.w3.org/2000/svg">
              <path
        ...
        <div class="relative z-0">
          <h1 class="font-display font-semibold sm:text-6xl text-5xl text-white">
            Discover tracklists you like
          </h1>
          <p class="text-2xl text-gray-200">
            A
            <span class="text-tracked-pink font-bold">better</span>
            and
            <span class="text-tracked-pink font-bold">simpler</span>
            alternative to 1001tracklist.
            <span class="text-tracked-pink font-bold italic">drops mic.</span>
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="bg-gradient-tr-pink-purple">
      <div class="container mx-auto px-8 sm:px-0 py-16 sm:pt-24 sm:pb-16">
        <div class="px-6 text-gray-200">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam enim sem, placerat id auctor ut, congue sed nisi. Maecenas fermentum libero in diam aliquam lobortis. Nunc sit amet sapien sollicitudin, aliquam lacus et, faucibus augue. Quisque quis rhoncus sapien. Sed lobortis erat sed justo condimentum interdum. Sed mattis laoreet nulla ac tempor. Suspendisse magna neque, varius vel dictum vel, eleifend nec lacus. Nullam faucibus finibus eros at pharetra. Sed aliquet massa ante. Donec mauris neque, lobortis a risus elementum, ullamcorper congue libero. Phasellus feugiat
        </div>
      </div>
    </div>
  </div>
